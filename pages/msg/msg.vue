<template>
	<view>
		...
		<!-- #ifndef H5 -->
		<uni-nav-bar :border="false" title="课程" onlive>
		</uni-nav-bar>
		<!-- #endif -->	
		
		<template>
			<view class="msg-lt-wrap">
				<text class="msg-lt-title">课程</text>
			</view>
			...
			<view class="msg-md-main">
				...
				<view class="msg-md-wrap">
					...
					<text class="msg-info"></text>
				</view>
				
			</view>
			<!-- 课程动态 -->
			<view class="msg-md-main"  @click="mycourse">
				<image src="../../static/images/class.png" mode="aspectFill" class="msg-img"></image>
				<view class="msg-md-wrap">
					<text class="msg-title">我的课程</text>
					<text class="msg-info"></text>
				</view>
