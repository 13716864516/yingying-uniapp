    ...
    <view class="login-all-wrap">
        ...
        <view class="px-2 login-input-wrap">
            <template v-if="!status">
                <view class="mb-2">
                    <input type="text" placeholder-style="color:#C9C9C9" v-model="username" placeholder="请输入您的手机号"
                           class="border-bottom p-2"/>
                </view>
                <view class="verify-code-wrap mb-2 flex align-stretch">
                    <input type="text" placeholder-style="color:#C9C9C9" v-model="code" :placeholder="placeholder"
                ...
                <view class="chongzhi-wrap">
                    <input type="text" placeholder-style="color:#C9C9C9" v-model="password" placeholder="请输入重置密码"
                           class="border-bottom p-2 flex-1"/>
                </view>
